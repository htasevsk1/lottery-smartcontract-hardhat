...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    function performUpkeep(
        ...
        // 2.Once we get it, do sth with it
        ...
        // Lock the lottery so no new players can enter
        s_raffleState = RaffleState.CALCULATING;

        uint256 requestId = i_vrfCoordinator.requestRandomWords(
            i_keyHash, // Gas lane
            i_subscribtionId, // Our subscription
            REQUEST_CONFIRMATIONS, // how many confirmation the Chainlink node should wait before responding
            i_callbackGasLimit, // How much gas to use for the callback request for fulfillRandomWords
            NUM_WORDS // How many random words we want to generate
        );
